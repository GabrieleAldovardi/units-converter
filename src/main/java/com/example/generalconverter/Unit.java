...
public class Unit {
    ...
    static final List<String> angles = Arrays.asList("Degrees", "Radiant");
    static final List<String> distances = Arrays.asList("Kilometer", "Meter", "Decimeter", "Centimeter", "Millimeter", "Micrometer", "Nanometer", "Feet", "Yard", "Inch", "Mile", "Light year");
    ...
    static final List<List<String>> allUnits = List.of(temperatures, angles, distances, weights, volumes, times,
